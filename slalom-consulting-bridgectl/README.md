...
[Detailed Installation Instructions](./BridgeCTL.wiki/Installation.md)
...
### Features
- Build Tableau Bridge docker container images. [detail](./BridgeCTL.wiki/Build-Bridge-Linux-Containers.md)
...
- Analyze bridge logs [detail](./BridgeCTL.wiki/Bridge-Log-Viewer.md)
...
- Monitor bridge agent health [detail](./BridgeCTL.wiki/Monitor-Bridge.md)
...
- Example Dockerfile Scripts [detail](./BridgeCTL.wiki/Example-Scripts.md)
...
### Release Notes
[Release Notes](./BridgeCTL.wiki/Release_Notes.md)
